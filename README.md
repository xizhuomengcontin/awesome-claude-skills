...
- [orca-replay](https://github.com/Continuum-AI-Corp/OrcaReplay/tree/main/skills/orca-replay) - Answers questions about an earlier agent run from its recording instead of from memory — which step changed a file, why a command ran, where the build broke — and can replay or fork that run offline. *By [@xizhuomengcontin](https://github.com/xizhuomengcontin)*
